...
import frame1 from '../assets/framePoro1.png'
import frame2 from '../assets/framePoro2.png'
import frame3 from '../assets/framePoro3.png'
  ...
  return (
    <>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', background: '#fff', fontFamily: 'Nunito, sans-serif', overflow: 'hidden' }}>
        ...
        {/* Step indicator */}
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'flex-start', gap: '0', padding: '1.5rem 2rem 0', flexShrink: 0 }}>
          {[
            { n: 1, label: 'frame\nselection' },
            { n: 2, label: 'pose\npengu' },
            { n: 3, label: 'add your\nphotos' },
            ...
            <div key={step.n} style={{ display: 'flex', alignItems: 'flex-start' }}>
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.4rem' }}>
                ...
                <div style={{ fontSize: '0.7rem', color: step.n === 1 ? '#111' : '#ccc', textAlign: 'center', lineHeight: 1.3, whiteSpace: 'pre-line' }}>
                  {step.label}
                </div>
              </div>
              {i < 3 && (
                <div style={{ width: 60, height: 2, background: '#ddd', marginTop: 15, flexShrink: 0 }} />
              )}
            </div>
          ))}
        </div>
        ...
        {/* Heading */}
        <p style={{ textAlign: 'center', fontFamily: 'Nunito', fontSize: '1rem', color: '#333', margin: '1.5rem 0 0' }}>
          choose your frame!
        </p>

        {/* Frames */}
        {/* Frames */}
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'space-evenly', padding: '1rem 4rem', minHeight: 0, width: '100%' }}>
          {FRAMES.map((f, i) => {
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '1rem', padding: '1.5rem 2.5rem', flexShrink: 0 }}>
          <button
            ...
            style={{
              ...
              borderRadius: '999px', padding: '0.8rem 2.5rem',
